...
// 
namespace Vertex.Fsd.Omiga.omFDM.CancelFulfilmentRequest 
{
    ...
    public class DirectGatewaySoapServiceWse : Microsoft.Web.Services2.WebServicesClientProtocol {
        ...
        [return: System.Xml.Serialization.XmlElementAttribute("ProcessCancelFulfilmentResponse", Namespace="http://processcancelfulfilment.fulfilment.services.dg.ingdirect.com/0.0.1")]
        public ProcessCancelFulfilmentResponseType execute([System.Xml.Serialization.XmlElementAttribute(Namespace="http://processcancelfulfilment.fulfilment.services.dg.ingdirect.com/0.0.1")] ProcessCancelFulfilmentRequestType ProcessCancelFulfilmentRequest) {
            object[] results = this.Invoke("execute", new object[] {
                        ProcessCancelFulfilmentRequest});
            return ((ProcessCancelFulfilmentResponseType)(results[0]));
        }
        
        /// <remarks/>
        public System.IAsyncResult Beginexecute(ProcessCancelFulfilmentRequestType ProcessCancelFulfilmentRequest, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("execute", new object[] {
                        ProcessCancelFulfilmentRequest}, callback, asyncState);
        }
        
        /// <remarks/>
        public ProcessCancelFulfilmentResponseType Endexecute(System.IAsyncResult asyncResult) {
    ...
    /// <remarks/>
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://processcancelfulfilment.fulfilment.services.dg.ingdirect.com/0.0.1")]
    public class ProcessCancelFulfilmentRequestType : GenericRequestType {
    ...
    [System.Xml.Serialization.XmlIncludeAttribute(typeof(ProcessCancelFulfilmentRequestType))]
    ...
    /// <remarks/>
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://generic.dg.ingdirect.com/0.0.1")]
    [System.Xml.Serialization.XmlIncludeAttribute(typeof(ProcessCancelFulfilmentResponseType))]
    ...
    /// <remarks/>
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://processcancelfulfilment.fulfilment.services.dg.ingdirect.com/0.0.1")]
    public class ProcessCancelFulfilmentResponseType : GenericResponseType {
        
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public string CancelFulfilmentResponse;
    }
}
