...
// 
namespace Vertex.Fsd.Omiga.omFDM.ResendFulfilmentRequest 
{
    ...
    public class DirectGatewaySoapServiceWse : Microsoft.Web.Services2.WebServicesClientProtocol {
        ...
        [return: System.Xml.Serialization.XmlElementAttribute("ProcessResendFulfilmentResponse", Namespace="http://processresendfulfilment.fulfilment.services.dg.ingdirect.com/0.0.1")]
        public ProcessResendFulfilmentResponseType execute([System.Xml.Serialization.XmlElementAttribute(Namespace="http://processresendfulfilment.fulfilment.services.dg.ingdirect.com/0.0.1")] ProcessResendFulfilmentRequestType ProcessResendFulfilmentRequest) {
            object[] results = this.Invoke("execute", new object[] {
                        ProcessResendFulfilmentRequest});
            return ((ProcessResendFulfilmentResponseType)(results[0]));
        }
        
        /// <remarks/>
        public System.IAsyncResult Beginexecute(ProcessResendFulfilmentRequestType ProcessResendFulfilmentRequest, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("execute", new object[] {
                        ProcessResendFulfilmentRequest}, callback, asyncState);
        }
        
        /// <remarks/>
        public ProcessResendFulfilmentResponseType Endexecute(System.IAsyncResult asyncResult) {
    ...
    /// <remarks/>
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://processresendfulfilment.fulfilment.services.dg.ingdirect.com/0.0.1")]
    public class ProcessResendFulfilmentRequestType : GenericRequestType {
    ...
    [System.Xml.Serialization.XmlIncludeAttribute(typeof(ProcessResendFulfilmentRequestType))]
    ...
    /// <remarks/>
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://generic.dg.ingdirect.com/0.0.1")]
    [System.Xml.Serialization.XmlIncludeAttribute(typeof(ProcessResendFulfilmentResponseType))]
    ...
    /// <remarks/>
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://processresendfulfilment.fulfilment.services.dg.ingdirect.com/0.0.1")]
    public class ProcessResendFulfilmentResponseType : GenericResponseType {
        
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public string ResendFulfilmentResponse;
    }
}
