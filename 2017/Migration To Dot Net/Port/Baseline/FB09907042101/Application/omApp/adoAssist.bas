...
'SR     27/08/04    BMIDS815   new method adoCheckRecordExists
'-------------------------------------------------------------------------------
'MARS History
'Prog   Date        Description
...
' application name
Private Const gstrAppName As String = "Omiga4"

' registry section for database connection info
Private Const gstrREGISTRY_SECTION As String = "Database Connection"

' registry keys for database connection info
Private Const gstrPROVIDER_KEY As String = "Provider"
Private Const gstrSERVER_KEY As String = "Server"
Private Const gstrDATABASE_KEY As String = "Database Name"
Private Const gstrUID_KEY As String = "User ID"
Private Const gstrPASSWORD_KEY As String = "Password"
Private Const gstrDATA_SOURCE_KEY As String = "Data Source"

' registry keys for other database info
Private Const gstrRETRIES_KEY As String = "Retries"
...
Public Enum DBPROVIDER
    ...
    omiga4DBPROVIDERMSOracle    'Support for MS and Oracle OLEDB Drivers
...
Public Sub adoGetAsXML( _
    ...
    Optional ByVal vstrFilter As String, _
    Optional ByVal vstrOrderBy As String)
...
On Error GoTo adoUpdateExit
    ...
    For Each xmlSchemaNode In xmlSchemaNodeList
        ...
        If Not xmlDataAttrib Is Nothing Then
            ...
            If Len(xmlDataAttrib.Value) > 0 Then
...
Public Function adoGetRecordSet( _
    ...
    ByVal vxmlSchemaNode As IXMLDOMNode, _
    Optional ByVal vstrFilter As String, _
    Optional ByVal vstrOrderBy As String) _
    As ADODB.Recordset
...
Public Function adoGuidToString(ByRef bytArray() As Byte) As String
    Dim i As Integer
...
Private Function GetErrorNumber(ByVal strErrDesc As String) As Long
...
Private Function ConvertGuidIndex(ByVal intIndex1 As Integer) As Integer
' header ----------------------------------------------------------------------------------
...
Public Function adoCheckRecordExists(ByVal strTableName As String, ByVal strKeys As String) As Boolean

On Error GoTo adoCheckRecordExistsVbErr

    Const strFunctionName As String = "adoCheckRecordExists"
    ...
    Set cmd = New ADODB.Command
    cmd.ActiveConnection = adoGetDbConnectString
    cmd.CommandText = strSQL
    Set rst = cmd.Execute(1, , adCmdText)

    If rst.BOF And rst.EOF Then
        adoCheckRecordExists = False
    Else
        adoCheckRecordExists = True
    End If
