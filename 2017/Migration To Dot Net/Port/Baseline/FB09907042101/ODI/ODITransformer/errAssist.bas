...
'SG      11/11/02    SYS5787 Implemented BMIDS00914 fix to CreateErrorResponseNode
'------------------------------------------------------------------------------------------
...
'------------------------------------------------------------------------------------------
    ...
    If errIsApplicationError() = True Then
        ...
        If Len(xmlDescriptionElem.Text) = 0 Then
            ...
            'SG 11/11/02 SYS5787 (BMIDS00914)
...
' TODO: Maybe redundant - check with IK against errAddWarning method?
