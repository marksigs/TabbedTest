...
'SG     27/06/02    SYS4962 Error handling in executeGetRecordSet
'SG     01/07/02    SYS5036 Reverse SYS4889 pending analysis of consequences.
'STB    01/07/02    SYS4752 SQL-Server (NOLOCK) hint facility added to SELECT statements.
'-------------------------------------------------------------------------------
Option Explicit
...
On Error GoTo executeGetRecordSetExit
    ...
    'SG 01/07/02 SYS5036 Comment out this call pending analysis of consequences
    '   'SG 27/06/02 SYS4962 START
    '   'SG 18/06/02 SYS4889
    '   'adoGetValidRecordset rst
    '   If Not adoGetValidRecordset(rst) Then
    '       errThrowError strFunctionName, oeRecordNotFound
    '   End If
    '   'SG 27/06/02 SYS4962 END
