...
Archive                  $Archive: /Epsom Phase2/2 INT Code/ExternalXML/transformStopAndSaveFMARequest.xslt $
Workfile                 $Workfile: transformStopAndSaveFMARequest.xslt $
...
Helen Aldred    	15/03/2006     	MAR1385 - Add CustomerRoleType to AccountRelationship.
IK						20/09/2006		EP2_1 - 'product' namespace identifiers
IK						18/11/2006		EP2_134 omiga client identifier
												EP2_134 drop OTHERCUSTOMERACCOUNTRELATIONSHIP
												EP2_134 drop DECISION
IK						09/01/2007		EP2_352 - always CREATE USERHISTORY
	...
	<xsl:template match="/">
		<xsl:for-each select="msxsl:node-set($firstPass)/REQUEST">
			<xsl:element name="REQUEST">
				<xsl:attribute name="OPERATION">StopAndSaveFMA</xsl:attribute>
