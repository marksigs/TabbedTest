   ...
   return(TenType);
	...
	<xsl:template match="/">
		<xsl:element name="TEMPLATEDATA">
			<xsl:variable name="CustCount" select="count(RESPONSE/CONDITIONREMOVAL/UNIQUEAPPLICATIONADDRESSES)"/>
			<xsl:variable name="CustRole" select="count(RESPONSE/CONDITIONREMOVAL/CUSTOMERROLE)"/>
				...
				<xsl:if test="($CustRole = '2')">
						<xsl:for-each select="//CUSTOMERROLE">
							...
							<xsl:if test="($Order_No = '1')">
									<xsl:variable name="SALUTATIONONE" select="msg:SetSalutation(string(.//CUSTOMERVERSION/@TITLE_TYPES), string(.//CUSTOMERVERSION/@TITLE_TEXT), string(.//CUSTOMERVERSION/@TITLEOTHER), string(.//CUSTOMERVERSION/@FIRSTFORENAME),string(.//CUSTOMERVERSION/@SURNAME),1)"/>
									...
									<xsl:variable name="AddressName" select="msg:GetApplicantNameWithInitials(string(.//CUSTOMERVERSION/@TITLE_TYPES), string(.//CUSTOMERVERSION/@TITLE_TEXT), string(.//CUSTOMERVERSION/@TITLEOTHER), string(.//CUSTOMERVERSION/@FIRSTFORENAME), string(.//CUSTOMERVERSION/@SECONDFORENAME),  string(.//CUSTOMERVERSION/@SURNAME),1)"/>

									
							</xsl:if>		
							<xsl:if test="($Order_No = '2')">
									<xsl:variable name="SALUTATIONONE" select="msg:SetSalutation(string(.//CUSTOMERVERSION/@TITLE_TYPES), string(.//CUSTOMERVERSION/@TITLE_TEXT), string(.//CUSTOMERVERSION/@TITLEOTHER), string(.//CUSTOMERVERSION/@FIRSTFORENAME), string(.//CUSTOMERVERSION/@SURNAME),2)"/>
