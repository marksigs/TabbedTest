...
function GetBothNames(Title,Surname)
{
	...
	<xsl:template match="/">
		<xsl:element name="TEMPLATEDATA">
			<xsl:variable name="CustCount" select="count(RESPONSE/APPEALLETTER/UNIQUEAPPLICATIONADDRESSES)"/>
			<xsl:variable name="CustRole" select="count(RESPONSE/APPEALLETTER/CUSTOMERROLE)"/>
