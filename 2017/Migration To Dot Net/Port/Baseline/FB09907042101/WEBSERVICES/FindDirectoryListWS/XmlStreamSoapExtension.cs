...
// SAB	19/09/2006 - EP2_1 - Updated Serialisation
// SR		23/10/2006  EP2_1 : Modified to check in
// IK		03/01/2007	EP2_653 - copy RESPONSE attributes
...
namespace Vertex.Fsd.Omiga.Web.Services.FindDirectoryListWS
{
    ...
    public class XmlStreamSoapExtension : SoapExtension
    {
		...
		private void om4Interface(XmlDocument soapOutXDoc)
		{
			...
			object[] lbop = new object[] {"FindDirectoryList",sx};
			XmlDocument xd = new XmlDocument();
