...
{
	/// <summary>
	/// Summary description for OmigaFindMortgageProductsService.
	/// </summary>
	[WebService(Namespace="http://FindMortgageProducts.Omiga.vertex.co.uk")]
	[WebServiceBinding(
		 Name="OmigaSoapRpcSoap",
		 Namespace="http://FindMortgageProducts.Omiga.vertex.co.uk",
		 Location="http://localhost/OmigaWebServices/Schemas/FindMortgageProducts.wsdl"
		 )]
	public class OmigaFindMortgageProductsService : Vertex.Fsd.Omiga.Web.Services.FindMortgageProductsWS.OmigaFindMortgageProducts
	{
		public OmigaFindMortgageProductsService()
		{
		...
		[SoapDocumentMethodAttribute( 
			 "http://Request.FindMortgageProducts.Omiga.vertex.co.uk", 
		...
		public override RESPONSEType findMortgageProducts()
		{
			try
			{		
