...
{
	/// <summary>
	/// Summary description for OmigaGetDocumentListService.
	/// </summary>
	[WebService(Namespace="http://GetDocumentList.IDUK.Omiga.marlboroughstirling.com")]
	[WebServiceBinding(
		 Name="OmigaSoapRpcSoap",
		 Namespace="http://GetDocumentList.IDUK.Omiga.marlboroughstirling.com",
		 Location="http://localhost/OmigaWebServices/Schemas/GetDocumentList.wsdl"
		 )]
	public class OmigaGetDocumentListService : Vertex.FSD.Omiga.Web.Services.GetDocumentListWS.OmigaGetDocumentList
	{
		public OmigaGetDocumentListService()
		{
		...
		[SoapDocumentMethodAttribute( 
			 "http://Request.GetDocumentList.IDUK.Omiga.marlboroughstirling.com", 
		...
		public override RESPONSEType getDocumentList()
		{
			try
			{		
