...
<span style="LEFT: 300px; POSITION: absolute; TOP: 176px">
...
<span style="LEFT: 300px; POSITION: absolute; TOP: 282px">
...
<span style="LEFT: 300px; POSITION: absolute; TOP: 557px">
<OBJECT id=scScrollTableIntroducer 
style="LEFT: 0px; WIDTH: 304px; TOP: 0px; HEIGHT: 24px" tabIndex=-1 
type=text/x-scriptlet data=scTableListScroll.asp VIEWASTEXT></OBJECT>
</span><!-- Hide this scroll bar for now -->
<span style="LEFT: 300px; VISIBILITY: hidden; POSITION: absolute; TOP: 190px">
...
<span style="LEFT: 300px; POSITION: absolute; TOP: 1244px">
...
<form id="frmScreen" mark validate="onchange" year4>
	<div id="divApplicants" style="LEFT: 10px; WIDTH: 604px; POSITION: absolute; TOP: 60px; HEIGHT: 235px" class="msgGroup">
	...
	<div id="divAppDetails" style="LEFT: 220px; WIDTH: 297px; POSITION: absolute; TOP: 584px; HEIGHT: 310px" class="msgGroup">
	...
	<div id="divMortgageDetails" style="LEFT: 10px; WIDTH: 604px; POSITION: absolute; TOP: 649px; HEIGHT: 235px" class="msgGroup">
	...
	<div id="divLoanDetails" style="LEFT: 10px; WIDTH: 604px; POSITION: absolute; TOP: 694px; HEIGHT: 235px" class="msgGroup">
	...
	<div id="divAppDetails1" style="LEFT: 10px; WIDTH: 297px; POSITION: absolute; TOP: 833px; HEIGHT: 310px" class="msgGroup">
		<span style="LEFT: 4px; POSITION: absolute; TOP: 10px" class="msgLabelHead">
			Application Details
		</span>
	...
	<div id="divAppDetails2" style="LEFT: 310px; WIDTH: 297px; POSITION: absolute; TOP: 859px; HEIGHT: 310px" class="msgGroup">
	...
	<div id="divCreditDecisionDetail" style="LEFT: 10px; WIDTH: 604px; POSITION: absolute; TOP: 1104px; HEIGHT: 235px" class="msgGroup">
		<span style="LEFT: 4px; POSITION: absolute; TOP: -13px" class="msgLabelHead" id=SPAN1>
...
Total
	...
	<div id="divThirdPartySummary" style="LEFT: 10px; WIDTH: 604px; POSITION: absolute; TOP: 1156px; HEIGHT: 235px" class="msgGroup">
...
%>	var sButtonList = new Array("Submit");
	...
	m_blnReadOnly = scScreenFunctions.SetMainScreenToReadOnly(window, frmScreen, "AP040");
...
function GetContactDetails()
{
	...
	return sContactXML;
	//var m_ContactXML = new top.frames[1].document.all.scXMLFunctions.XMLObject();
	//m_ContactXML.XMLDocument.loadXML(ContactXML.xml);
