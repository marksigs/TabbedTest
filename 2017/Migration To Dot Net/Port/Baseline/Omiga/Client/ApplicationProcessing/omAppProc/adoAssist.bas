...
'
'Prog   Date        Description
'MV     14/06/2002  BMIDS00013 - Modified executeGetRecordSet()
'MV     18/06/2002  BMIDS00013 - Modified executeGetRecordSet()
'MV     19/06/2002  BMIDS00013 - Modified executeGetRecordSet()
'MV     28/06/2002  BMIDS00013 - Modified executeGetRecordSet()
'MV     27/08/2002  BMIDS00109 - Modified executeGetRecordSet()- Removed validation adoGetValidRecordset()
'RF     15/11/2002  BMIDS00935 - Applied SYS4752 as implemented in SYSMCP0734:
'                                Use NOLOCK hint to prevent deadlocks -
'                                modified adoGetRecordset & GetNextKeySequence
'-----------------------------------------------------------------------------
...
Public Function executeGetRecordSet(ByVal cmd As ADODB.Command) As ADODB.Recordset
    ...
    Dim blnValidRecordSet  As Boolean
