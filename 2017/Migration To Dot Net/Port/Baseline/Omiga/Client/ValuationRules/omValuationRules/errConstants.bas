...
'
'Prog   Date        Description
'GHun   28/04/2004  Added errors 800, 801 which are already in other versions of ErrConstants
'------------------------------------------------------------------------------------------
'MARS History:
'
'Prog   Date        Description
...
Public Const clngMAX_ERROR_NO As Long = 10000
Public Const clngADO_START_ERROR_NO As Long = 3000
Public Const clngADO_END_ERROR_NO As Long = 3999
