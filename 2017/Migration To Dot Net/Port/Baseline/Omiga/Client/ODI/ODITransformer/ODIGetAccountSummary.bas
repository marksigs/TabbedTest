...
'PSC    17/01/07    EP2_855 Make payment source sequence number a long
'------------------------------------------------------------------------------------------
Option Explicit
...
On Error GoTo AddMortgageDetailsExit
    ...
    Dim lngMaxSeqNo As Long         ' PSC 17/01/2007 EP2_855
    ...
    For Each nodeTemp In nodelistOptimusPaymentSources
        ...
        If CSafeLng(strThisSeqNo) > lngMaxSeqNo Then
            ' PSC 17/01/2007 EP2_855
            lngMaxSeqNo = CSafeLng(strThisSeqNo)
