Attribute VB_Name = "ODIGetPaymentAmount"
'Workfile:      ODIGetPaymentAmount.bas
...
'   oeRecordNotFound
'------------------------------------------------------------------------------------------
On Error GoTo GetPaymentAmountExit
    
    Const strFunctionName As String = "GetPaymentAmount"
