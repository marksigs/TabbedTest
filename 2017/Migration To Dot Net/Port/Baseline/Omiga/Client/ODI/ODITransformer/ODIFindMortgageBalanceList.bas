Attribute VB_Name = "ODIFindMortgageBalanceList"
'Workfile:      ODIFindMortgageBalanceList.cls
...
Public Sub FindMortgageBalanceList( _
...
'   oeRecordNotFound
'------------------------------------------------------------------------------------------
On Error GoTo FindMortgageBalanceListExit
    
    Const strFunctionName As String = "FindMortgageBalanceList"
