...
Private Function GetGlobalParam( _
    ...
    #If USING_VSA Then
        Dim VSA As New vsa_shared: VSA.Initialize (gstrMODULEPREFIX & cstrFunctionName)
    #End If
    ...
    ' <VSA> Visual Studio Analyser Support
    #If USING_VSA Then
        VSA.Fire_DEBUG_EVENT_CALL "create FreeThreadedDOMDocument40"
    #End If
    ...
    ' <VSA> Visual Studio Analyser Support
    #If USING_VSA Then
        VSA.Fire_DEBUG_EVENT_RETURN "create FreeThreadedDOMDocument40"
    #End If
    
    ' <VSA> Visual Studio Analyser Support
    #If USING_VSA Then
        VSA.Fire_DEBUG_EVENT_CALL "create BOGUS root node"
    #End If
    ...
    ' <VSA> Visual Studio Analyser Support
    #If USING_VSA Then
        VSA.Fire_DEBUG_EVENT_RETURN "create BOGUS root node"
    #End If
    
    ' <VSA> Visual Studio Analyser Support
    #If USING_VSA Then
        VSA.Fire_DEBUG_EVENT_CALL "create schema for OM_GLOBALPARAM view"
    #End If
    ...
    ' <VSA> Visual Studio Analyser Support
    #If USING_VSA Then
        VSA.Fire_DEBUG_EVENT_RETURN "create schema for OM_GLOBALPARAM view"
    #End If
    
    ' <VSA> Visual Studio Analyser Support
    #If USING_VSA Then
        VSA.Fire_DEBUG_EVENT_CALL "create REQUEST details"
    #End If
    ...
    ' <VSA> Visual Studio Analyser Support
    #If USING_VSA Then
        VSA.Fire_DEBUG_EVENT_RETURN "create REQUEST details"
    #End If
    
    ' <VSA> Visual Studio Analyser Support
    #If USING_VSA Then
        VSA.Fire_DEBUG_EVENT_CALL "create RESPONSE node"
    #End If
    ...
    ' <VSA> Visual Studio Analyser Support
    #If USING_VSA Then
        VSA.Fire_DEBUG_EVENT_RETURN "create RESPONSE node"
    #End If
    
    ' <VSA> Visual Studio Analyser Support
    #If USING_VSA Then
        VSA.Fire_DEBUG_EVENT_CALL "call adoGetRecordSetAsXML"
    #End If
    ...
    ' <VSA> Visual Studio Analyser Support
    #If USING_VSA Then
        VSA.Fire_DEBUG_EVENT_RETURN "call adoGetRecordSetAsXML"
    #End If
    
    ' <VSA> Visual Studio Analyser Support
    #If USING_VSA Then
        VSA.Fire_DEBUG_EVENT_CALL "parse response"
    #End If
    ...
    ' <VSA> Visual Studio Analyser Support
    #If USING_VSA Then
        VSA.Fire_DEBUG_EVENT_RETURN "parse response"
    #End If
    
    ' <VSA> Visual Studio Analyser Support
    #If USING_VSA Then
        VSA.Fire_DEBUG_EVENT_CALL "exit housekeeping"
    #End If
    ...
    ' <VSA> Visual Studio Analyser Support
    #If USING_VSA Then
        VSA.Fire_DEBUG_EVENT_RETURN "exit housekeeping"
    #End If
