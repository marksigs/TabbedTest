...
Option Explicit
'RF 30/03/06 Dummy change to associate with Clearquest
' --------------------------------------------------------------
...
On Error GoTo errHandler
  ...
  If regDoes_Key_Exist(lngRootKey, "Software\OmigaSoftConfig\TMRules") Then
        ...
        intLogLevel = regQuery_A_Key(lngRootKey, "Software\OmigaSoftConfig\TMRules", "LogLevel")
        strPath = regQuery_A_Key(lngRootKey, "Software\OmigaSoftConfig\TMRules", "LogPath")
