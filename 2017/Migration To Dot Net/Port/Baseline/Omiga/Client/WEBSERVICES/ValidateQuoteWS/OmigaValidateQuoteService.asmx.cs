...
{
	/// <summary>
	/// Summary description for OmigaValidateQuoteService.
	/// </summary>
	[WebService(Namespace="http://ValidateQuote.IDUK.Omiga.marlboroughstirling.com")]
	[WebServiceBinding(
		 Name="OmigaSoapRpcSoap",
		 Namespace="http://ValidateQuote.IDUK.Omiga.marlboroughstirling.com",
		 Location="http://localhost/OmigaWebServices/Schemas/ValidateQuote.wsdl"
		 )]
	public class OmigaValidateQuoteService : OmigaValidateQuote
	{
		public OmigaValidateQuoteService()
		{
		...
		[SoapDocumentMethodAttribute( 
			 "http://Request.ValidateQuote.IDUK.Omiga.marlboroughstirling.com", 
		...
		public override RESPONSEType ValidateQuote()
		{
			try
			{		
