...
// Updated the namespaces as part of EP2_1
// SR   23/10/2006      EP2_1 : Modified to check in

namespace Vertex.Fsd.Omiga.Web.Services.FindDirectoryListWS
{
	/// <summary>
	/// Summary description for OmigaFindDirectoryListService.
	/// </summary>
	[WebService(Namespace="http://FindDirectoryList.Omiga.vertex.co.uk")]
	[WebServiceBinding(
		 Name="OmigaSoapRpcSoap",
		 Namespace="http://FindDirectoryList.Omiga.vertex.co.uk",
		 Location="http://localhost/OmigaWebServices/Schemas/FindDirectoryList.wsdl"
		 )]
	public class OmigaFindDirectoryListService : Vertex.Fsd.Omiga.Web.Services.FindDirectoryListWS.OmigaFindDirectoryList
	{
		public OmigaFindDirectoryListService()
		{
		...
		[SoapDocumentMethodAttribute( 
			 "http://Request.FindDirectoryList.Omiga.vertex.co.uk", 
		...
		public override RESPONSEType findDirectoryList()
		{
			try
			{		
