//
//--------------------------------------------------------------------------------------------
//Archive			$Archive: /Epsom Phase2/2 INT Code/WebServices/SubmitFMAWS/XmlStreamSoapExtension.cs $
...
//IK	21/09/2006	EP2_1 remove xmlns="" etc.
// SR   23/10/2006  EP2_1 : Modified to check in
//IK    23/11/2006  EP2_159 : prevent REQUEST de-serialization
//--------------------------------------------------------------------------------------------
//
using System;
...
namespace Vertex.Fsd.Omiga.Web.Services.SubmitFMAWS
{
    ...
    public class XmlStreamSoapExtension : SoapExtension
    {
        ...
        public override Stream ChainStream(Stream stream)
        {
			...
			const string emptySubmitFMARequest = soapPreamble + "<REQUEST xmlns='http://Request.SubmitFMA.Omiga.vertex.co.uk'></REQUEST>" + soapPostamble;
			// EP2_159_ends
            ...
            else 
            {
				...
				sw.Write(emptySubmitFMARequest);
				sw.Flush();
		...
		private void om4Interface(XmlDocument soapOutXDoc)
		{
			...
			object[] lbop = new object[] {"SubmitFMA",sx};
			XmlDocument xd = new XmlDocument();
