...
{
	/// <summary>
	/// Summary description for OmigaFindBusinessForCustomerService.
	/// </summary>
	[WebService(Namespace="http://FindBusinessForCustomer.IDUK.Omiga.marlboroughstirling.com")]
	[WebServiceBinding(
		 Name="OmigaSoapRpcSoap",
		 Namespace="http://FindBusinessForCustomer.IDUK.Omiga.marlboroughstirling.com",
		 Location="http://localhost/OmigaWebServices/Schemas/FindBusinessForCustomer.wsdl"
		 )]
	public class OmigaFindBusinessForCustomerService : Vertex.FSD.Omiga.Web.Services.FindBusinessForCustomerWS.OmigaFindBusinessForCustomer
	{
		public OmigaFindBusinessForCustomerService()
		{
		...
		[SoapDocumentMethodAttribute( 
			 "http://Request.FindBusinessForCustomer.IDUK.Omiga.marlboroughstirling.com", 
		...
		public override RESPONSEType findBusinessForCustomer()
		{
			try
			{		
