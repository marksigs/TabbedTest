...
{
	/// <summary>
	/// Summary description for OmigaGetCaseTrackingDataService.
	/// </summary>
	[WebService(Namespace="http://GetCaseTrackingData.Omiga.vertex.co.uk")]
	[WebServiceBinding(
		 Name="OmigaSoapRpcSoap",
		 Namespace="http://GetCaseTrackingData.Omiga.vertex.co.uk",
		 Location="http://localhost/OmigaWebServices/Schemas/GetCaseTrackingData.wsdl"
		 )]
	public class OmigaGetCaseTrackingDataService : Vertex.Fsd.Omiga.Web.Services.GetCaseTrackingDataWS.OmigaGetCaseTrackingData
	{
		public OmigaGetCaseTrackingDataService()
		{
		...
		[SoapDocumentMethodAttribute( 
			 "http://Request.GetCaseTrackingData.Omiga.vertex.co.uk", 
		...
		public override RESPONSEType getCaseTrackingData()
		{
			try
			{		
