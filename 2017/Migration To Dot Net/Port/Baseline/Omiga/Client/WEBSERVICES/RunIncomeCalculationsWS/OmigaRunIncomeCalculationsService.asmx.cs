...
{
	/// <summary>
	/// Summary description for OmigaRunIncomeCalculationsService.
	/// </summary>
	[WebService(Namespace="http://RunIncomeCalculations.IDUK.Omiga.marlboroughstirling.com")]
	[WebServiceBinding(
		 Name="OmigaSoapRpcSoap",
		 Namespace="http://RunIncomeCalculations.IDUK.Omiga.marlboroughstirling.com",
		 Location="http://localhost/OmigaWebServices/Schemas/RunIncomeCalculations.wsdl"
		 )]
	public class OmigaRunIncomeCalculationsService : Vertex.FSD.Omiga.Web.Services.RunIncomeCalculationsWS.OmigaRunIncomeCalculations
	{
		public OmigaRunIncomeCalculationsService()
		{
		...
		[SoapDocumentMethodAttribute( 
			 "http://Request.RunIncomeCalculations.IDUK.Omiga.marlboroughstirling.com", 
		...
		public override RESPONSEType runIncomeCalculations()
		{
			try
			{		
