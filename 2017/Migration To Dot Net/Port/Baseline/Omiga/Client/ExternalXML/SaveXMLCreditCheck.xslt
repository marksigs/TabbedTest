...
01.10   PSC			05/01/07     EP2_576 New BureauData BES1 fields
01.11   AW			15/03/07     EP2_1950  New BureauDecision DEC7 fields, new CREDITCHECKREPORTINGBLOCK block
================================================================================-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:variable name="DEU1" select="$CreditCheckRoot/DEU1"/>
	<xsl:template match="/">
		 <xsl:element name="DATA">
			<xsl:element name="MISC">
				...
				<xsl:element name="BESPOKEDECISION">
					...
					<xsl:attribute name="TIMEBANKRUPTCYDISCHARGE"><xsl:value-of select="$DEC7/TIMEBNKRPTDSCHGE"/></xsl:attribute>
					<xsl:attribute name="TIMERECEIVEDIVA"><xsl:value-of select="$DEC7/TIMERECIVA"/></xsl:attribute>
					<xsl:attribute name="AGEMAINAPPLICANT"><xsl:value-of select="$DEC7/AGEMAINAPP"/></xsl:attribute>
					<xsl:attribute name="AGEJOINTAPPLICANT"><xsl:value-of select="$DEC7/AGEJOINTAPP"/></xsl:attribute>
					<xsl:attribute name="TOTALNUMBERSETTLEDCAIS"><xsl:value-of select="$DEC7/TOTNOSETCAIS"/></xsl:attribute>
					<xsl:attribute name="LOANTOINCOME"><xsl:value-of select="$DEC7/LOANTOINCOME"/></xsl:attribute>
					<xsl:attribute name="BUYERTYPE"><xsl:value-of select="$DEC7/BUYERTYPE"/></xsl:attribute>
					<xsl:attribute name="JOINTAPPTIMECURRENTEMP"><xsl:value-of select="$DEC7/JOINTAPPTIMECURREMP"/></xsl:attribute>
					<xsl:attribute name="LOANTOINCOMESCF"><xsl:value-of select="$DEC7/LOANTOINCSCF"/></xsl:attribute>
					<xsl:attribute name="JOINTAPPEMPSTATUS"><xsl:value-of select="$DEC7/JOINTAPPEMPSTAT"/></xsl:attribute>
				</xsl:element>
				...
				<xsl:element name="CREDITCHECKREPORTINGBLOCK">
					<xsl:element name="CREDITCHECKREPORTINGDATA">
						<xsl:attribute name="DEU1_BUYERTYPE"><xsl:value-of select="$DEU1/BUYERTYPE"/></xsl:attribute>
						<xsl:attribute name="DEU1_AGEJOINTAPP"><xsl:value-of select="$DEU1/AGEJOINTAPP"/></xsl:attribute>
						<xsl:attribute name="DEU1_AGEMAINAPP"><xsl:value-of select="$DEU1/AGEMAINAPP"/></xsl:attribute>
						<xsl:attribute name="DEU1_SELFCERTFLAG"><xsl:value-of select="$DEU1/SELFCERTFLAG"/></xsl:attribute>
						<xsl:attribute name="DEU1_AMOUNT"><xsl:value-of select="$DEU1/AMOUNT"/></xsl:attribute>
						<xsl:attribute name="DEU1_GROSSMAINANNUALINC"><xsl:value-of select="$DEU1/GROSSANNUALINC[1]"/></xsl:attribute>
						<xsl:attribute name="DEU1_GROSSJOINTANNUALINC"><xsl:value-of select="$DEU1/GROSSANNUALINC[2]"/></xsl:attribute>
						<xsl:attribute name="DEU1_TIMEWITHEMP"><xsl:value-of select="$DEU1/TIMEWITHEMP"/></xsl:attribute>
						<xsl:attribute name="DEU1_EMPTYPE"><xsl:value-of select="$DEU1/EMPTYPE"/></xsl:attribute>
						<xsl:attribute name="DEU1_PRODUCTTYPE"><xsl:value-of select="$DEU1/PRODUCTTYPE"/></xsl:attribute>					
					</xsl:element>
				</xsl:element>
			</xsl:element>
			...
			<xsl:element name="BESPOKEBUREAUDATABLOCK">
				<xsl:element name="BESPOKEBUREAUDATA">
					...
					<xsl:attribute name="BES1_NUMBERACTIVECARDS"><xsl:value-of select="$BES1/NO_ACT_CARD"/></xsl:attribute>
					<xsl:attribute name="BES1_BALANCEACTIVECARDS"><xsl:value-of select="$BES1/SUM_CURR_CARDBAL"/></xsl:attribute>
					<xsl:attribute name="BES1_NUMBERLOANSL12M"><xsl:value-of select="$BES1/NO_LOANS_LESS_12M_REMAIN"/></xsl:attribute>
					<xsl:attribute name="BES1_TOTALREPAYLOANSL12M"><xsl:value-of select="$BES1/SUM_MPAY_LOAN_LESS_12M"/></xsl:attribute>
					<xsl:attribute name="BES1_NUMBERLOANSM12M"><xsl:value-of select="$BES1/NO_LOANS_MORE_12M_REMAIN"/></xsl:attribute>
					<xsl:attribute name="BES1_TOTALREPAYLOANSM12M"><xsl:value-of select="$BES1/SUM_MPAY_LOAN_MORE_12M"/></xsl:attribute>
				</xsl:element>
			</xsl:element>
		</xsl:element>
	</xsl:template>
