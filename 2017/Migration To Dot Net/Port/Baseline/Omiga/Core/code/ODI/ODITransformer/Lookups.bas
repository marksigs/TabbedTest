...
'------------------------------------------------------------------------------------------
    ...
    Dim objMort As Object
    Dim xmlRequestDoc As New FreeThreadedDOMDocument
    Dim strConvertedValue As String
    Dim xmlRequestNode As IXMLDOMNode
    Dim xmlResponseDoc As New FreeThreadedDOMDocument
    ...
    Else
        ...
        Else
            ' fixme
            Set objMort = CreateObject("MortgageProductBO")
