Attribute VB_Name = "ODICreateBaseRateSet"
'Workfile:      ODICreateBaseRateSet.bas
...
Public Sub CreateBaseRateSet(ByVal objODITransformerState As ODITransformerState, _
...
'------------------------------------------------------------------------------------------
    ...
    Const strFunctionName As String = "CreateBaseRateSet"
    
    On Error GoTo CreateBaseRateSetExit
