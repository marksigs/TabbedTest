<%@ Page language="c#" Codebehind="AdviserDetails.aspx.cs" AutoEventWireup="false" Inherits="Epsom.Web.App.AdviserDetails" %>
...
<mp:contentcontainer id="Contentcontainer1" runat="server" masterpagefile="../masterpages/masterpage2.ascx">
  ...
  <cms:helplink id="helplink" class="helplink" runat="server" helpref="2010" />
    ...
    <epsom:adviser id="ctlAdviser" runat="server" DisplayOnly="true"></epsom:adviser>
