...
{
	/// <summary>
	/// Summary Form. Allows user to submit and get KFI, or to return to any of the KFI forms.
	/// </summary>
    ...
    protected WebUserControls.FeesSummary ctlFeesSummary;
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
      ...
      if (IsPostBack)
      {
        ...
        {
          Epsom.Web.Proxy.CreateKfiResponse createKfiResponse = WebServiceHelper.Instance.SubmitKfi(HttpSession.CurrentApplication);

          if (createKfiResponse.ResponseMessages != null && createKfiResponse.ResponseMessages.Length > 0)
          {
            throw new Exception(createKfiResponse.ResponseMessages[0].Text);
          }

          HttpSession.CreateKfiResponse = createKfiResponse; 
    ...
    private void Scatter()
    {
      ...
      ctlFeesSummary.Scatter(HttpSession.CurrentApplication);
