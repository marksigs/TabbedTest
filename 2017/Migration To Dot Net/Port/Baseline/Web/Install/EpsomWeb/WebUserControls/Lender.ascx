<%@ Control Language="c#" AutoEventWireup="false" Codebehind="Lender.ascx.cs" Inherits="Epsom.Web.WebUserControls.Lender" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
