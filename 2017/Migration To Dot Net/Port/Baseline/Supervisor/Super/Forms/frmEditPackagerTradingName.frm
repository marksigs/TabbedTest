...
Begin VB.Form frmEditPackagerTradingName 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Add/Edit Trading Names"
   ClientHeight    =   2265
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9135
   Icon            =   "frmEditPackagerTradingName.frx":0000
   LinkTopic       =   "Form7"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   2265
   ...
   End
End
Attribute VB_Name = "frmEditPackagerTradingName"
...
Dim clsTableAccess As TableAccess
    ...
    m_clsFirmTradingNameTable.SetPrincipalfirmID txtPrincipalFirmID.Text
    m_clsFirmTradingNameTable.SetARFirmID ""
