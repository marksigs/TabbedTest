...
Begin VB.Form frmEditIndividualARBroker 
   Caption         =   "Add/Edit Individual AR Broker"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9375
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmEditIndividualARBroker.frx":0000
      ...
      TabCaption(1)   =   "AR Firms"
      TabPicture(1)   =   "frmEditIndividualARBroker.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Frame6"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "User Details"
      TabPicture(2)   =   "frmEditIndividualARBroker.frx":0038
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.CommandButton cmdAddFirm 
            ...
            Left            =   240
            TabIndex        =   21
            ToolTipText     =   "Add or Delete Associated AR Firms"
            Top             =   4800
            Width           =   1275
         End
   ...
   End
End
Attribute VB_Name = "frmEditIndividualARBroker"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' Form          : frmEditIndividualARBroker
...
Const mc_strTHIS_MODULE As String = "frmEditIndividualARBroker"
...
' Remove Link from Introducer via Introducer Firm to ARFirm or PrincipalFirm
    ...
    strSQL = "SELECT * FROM INTRODUCERFIRM WHERE INTRODUCERID = '" & strIntroducerID & "' AND NOT ARFIRMID IS NULL"
...
Dim m_clsIntroducerARIndividualTable As New IntroducerARIndividualTable
Dim colMatchValues As Collection
    ...
    m_clsIntroducerARIndividualTable.GetLinkedARFirmRecords strIntroducerID
    lvFirms.LoadColumnDetails TypeName(m_clsIntroducerARIndividualTable)
    
    TableAccess(m_clsIntroducerARIndividualTable).GetTableData POPULATE_FIRST_BAND
    g_clsFormProcessing.PopulateFromRecordset frmEditIndividualARBroker.lvFirms, m_clsIntroducerARIndividualTable
    Exit Sub
Failed:
    g_clsErrorHandling.RaiseError Err.Number, Err.DESCRIPTION
End Sub
...
' TW 06/12/2006 EP2_301 End
            If lvFirms.ListItems.Count = 0 Then
                bRet = False
                MsgBox "There are no AR Firm(s) associated with this Introducer. Please make an association"
                SSTab1.Tab = 2
            Else
' TW 10/01/2007 EP2_637
                UpdateUserFields
...
' TW 09/02/2007 EP2_1296 End
    ...
    If frmMaintainFSAAssociations.GetReturnCode() = MSGSuccess Then
...
' TW 14/05/2007 VR216 End
    ...
    End If
    PopulateAssociatedFirmsListView
    strSearchType = "AR Individual Broker"
...
Private Sub SetEditState()
    ...
    If Not objRS Is Nothing Then
        ...
        Else
            g_clsErrorHandling.RaiseError errGeneralError, "Edit AR Broker - no records exist"
        End If
    End If
    '
CleanUp:
