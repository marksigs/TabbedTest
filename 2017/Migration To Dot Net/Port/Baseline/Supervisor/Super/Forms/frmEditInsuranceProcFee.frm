VERSION 5.00
Object = "{E967AC11-6BA4-11D5-8312-000102A316E5}#1.0#0"; "MSGOCX.ocx"
Begin VB.Form frmEditInsuranceProcFee 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Add/Edit Insurance Product Fee Details"
   ClientHeight    =   4785
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6285
   Icon            =   "frmEditInsuranceProcFee.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4785
   ...
   End
End
Attribute VB_Name = "frmEditInsuranceProcFee"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' Form          :   frmEditInsuranceProcFee
...
Private Sub SetEditState()
    ...
    If TableAccess(m_clsProcFee).RecordCount > 0 Then
        SetScreenFields
    Else
        g_clsErrorHandling.RaiseError errGeneralError, "No records returned"
    End If
...
Private Sub SaveSplitDetails(sType As String, txt As MSGEditBox)
    ...
    If Len(sType) > 0 Then
        ...
        Else
            ...
            clsSplit.GetSplitAmounts sGuid, sType, m_sSplitSequence, True
            TableAccess(m_clsProcFeeForInt).SetRecordSet TableAccess(clsSplit).GetRecordSet
...
Public Sub SetScreenFields()
    ...
    sProduct = clsProcFee.GetProductID
    If Len(sProduct) > 0 Then
        HandleProduct sProduct
    End If
...
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
Private Sub HandleProduct(sProduct As String)
    On Error GoTo Failed
    ...
    sName = clsCombo.FindComboValue("InsuranceType", sProduct)

    txtProdProcFees(PRODUCT_TYPE).Text = sName
