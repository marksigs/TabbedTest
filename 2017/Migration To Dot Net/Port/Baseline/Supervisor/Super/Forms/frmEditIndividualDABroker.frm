...
Begin VB.Form frmEditIndividualDABroker 
   Caption         =   "Add/Edit Individual DA Broker"
   ClientHeight    =   6855
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9345
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmEditIndividualDABroker.frx":0000
      ...
      TabCaption(1)   =   "DA Firms"
      TabPicture(1)   =   "frmEditIndividualDABroker.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Frame6"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "User Details"
      TabPicture(2)   =   "frmEditIndividualDABroker.frx":0038
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.CommandButton cmdAddFirm 
            ...
            Left            =   240
            TabIndex        =   21
            ToolTipText     =   "Add or Delete Associated DA Firms"
            Top             =   4800
            Width           =   1275
         End
   ...
   End
End
Attribute VB_Name = "frmEditIndividualDABroker"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' Form          : frmEditIndividualDABroker
...
' PE        21/03/2007  EP2_2046 - Default "Appointed Rep" to No.
...
Const mc_strTHIS_MODULE As String = "frmEditIndividualDABroker"
...
Dim m_clsIntroducerDAIndividualTable As New IntroducerDAIndividualTable
Dim colMatchValues As Collection
    ...
    m_clsIntroducerDAIndividualTable.GetLinkedDAFirmRecords strIntroducerID
    lvFirms.LoadColumnDetails TypeName(m_clsIntroducerDAIndividualTable)
    
    TableAccess(m_clsIntroducerDAIndividualTable).GetTableData POPULATE_FIRST_BAND
    g_clsFormProcessing.PopulateFromRecordset frmEditIndividualDABroker.lvFirms, m_clsIntroducerDAIndividualTable
...
' TW 06/12/2006 EP2_301 End
            If lvFirms.ListItems.Count = 0 Then
                bRet = False
                MsgBox "There are no DA Firm(s) associated with this Introducer. Please make an association"
                SSTab1.Tab = 2
            Else
' TW 10/01/2007 EP2_637
                UpdateUserFields
...
' TW 14/05/2007 VR216 End
    ...
    End If
    PopulateAssociatedFirmsListView
    strSearchType = "DA Individual Broker"
