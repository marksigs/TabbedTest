...
Begin VB.Form frmFindARBroker 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Find AR Broker"
   ClientHeight    =   6360
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   8775
   Icon            =   "frmFindARBroker.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6360
   ...
   End
End
Attribute VB_Name = "frmFindARBroker"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' Form          : frmFindARBroker
...
Private m_objARBrokerTable As ARBrokerTable


'PB 09/11/2006 EP2_13
Public Sub SetTableClass(objTableClass As ARBrokerTable)
    Set m_objARBrokerTable = objTableClass
End Sub
'PB End
...
' Description   : Opens the ARBroker form in edit mode.
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
Private Sub Form_Load()
    ...
    Set m_objARBrokerTable = New ARBrokerTable
...
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' Function      : FindARBroker
' Description   : Returns all matching ARBroker records.
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
Private Sub FindARBroker()
    
    'Dim uARBrokerType As ARBrokerTypeEnum
    Dim clsFindARBroker As ARBrokerSearch
    
    On Error GoTo Failed
    
    'Create a class used to search.
    Set clsFindARBroker = New ARBrokerSearch

'    'Set the Company Name criteria.
'    If Me.txtTitle.Enabled = True Then
'        clsFindARBroker.SetTitle Me.txtTitle.Text
'    End If
'
'    'Set the forename criteria.
'    If Me.txtForename.Enabled = True Then
'        clsFindARBroker.SetForename Me.txtForename.Text
'    End If
'
'    'Set the othernames criteria.
'    If Me.txtInitials.Enabled Then
'        clsFindARBroker.SetInitials Me.txtInitials.Text
'    End If
'
'    'Set the surname criteria.
'    If Me.txtSurname.Enabled Then
'        clsFindARBroker.SetSurname Me.txtSurname.Text
'    End If
    
    'Set the Name criteria.
    If Me.txtFirmName.Enabled = True Then
        clsFindARBroker.SetFirmName Me.txtFirmName.Text
    End If

' TW 16/01/2007 EP2_859
    'Set the Introducer Id criteria.
    If Me.txtIntroducerId.Enabled = True Then
        clsFindARBroker.SetIntroducerID Me.txtIntroducerId.Text
    End If
' TW 16/01/2007 EP2_859 End
    
    'Set the FSA ref criteria.
    If Me.txtFSAReference.Enabled = True Then
        clsFindARBroker.SetFSARef Me.txtFSAReference.Text
    End If
    
    'Set the address criteria.
    If Me.txtFirmAddress.Enabled Then
        clsFindARBroker.SetAddress Me.txtFirmAddress.Text
    End If
    
    'Perform a search and populate the table object.
    clsFindARBroker.Find m_objARBrokerTable
...
Private Sub PopulateLV()
    ...
    If TableAccess(m_objARBrokerTable).RecordCount > 0 Then
        For nThisInt = 1 To TableAccess(m_objARBrokerTable).RecordCount
            Set lvItem = lvResults.ListItems.Add
            
            'Unique key
            lvItem.Key = "intro_" & m_objARBrokerTable.GetIntroducerID & m_objARBrokerTable.GetFSARef
            
            'Because the key can only be a string value, the guid must be stored in the tag as a byte()
            lvItem.Tag = m_objARBrokerTable.GetIntroducerID
            
            lvItem.Text = m_objARBrokerTable.GetIntroducerID
' TW 16/01/2007 EP2_859
...
' TW 16/01/2007 EP2_859 End
            lvItem.ListSubItems.Add , , m_objARBrokerTable.GetUserName
            lvItem.ListSubItems.Add , , m_objARBrokerTable.GetAddress
            
            TableAccess(m_objARBrokerTable).MoveNext
        Next
' TW 16/01/2007 EP2_859
    Else
...
Private Sub Form_Unload(Cancel As Integer)
    Set m_objARBrokerTable = Nothing
End Sub


'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' Function      : lvResults_DblClick
' Description   : Open the selected ARBroker.
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' Function      : EditARBroker
' Description   : Loads frmEditARBroker passing through the GUID
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
Private Sub EditARBroker()
        
    Dim vGUID As Variant
    Dim colKeys As Collection
    Dim frmEdit As frmEditIndividualARBroker
