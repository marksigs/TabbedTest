...
' Written by Kenneth Ives                        kenaso@hom.com
...
On Error GoTo errHandler
  ...
  If regDoes_Key_Exist(lngRootKey, "Software\OmigaSoftConfig\CDRules") Then
        intLogLevel = regQuery_A_Key(lngRootKey, "Software\OmigaSoftConfig\CDRules", "LogLevel")
        strPath = regQuery_A_Key(lngRootKey, "Software\OmigaSoftConfig\CDRules", "LogPath")
...
Public Function LogDetails(Loglevel As Integer, strDescription As String, Optional xmlrequest As MSXML2.FreeThreadedDOMDocument40, Optional strFilename As String)
