...
'SR     03/12/2007  CORE00000339 - remove 'On Error GoTo 0' prior to migration
...
'FIXIT: Declare 'strRequestDataNodeName' with an early-bound data type                     FixIT90210ae-R1672-R1B8ZE
...
'FIXIT: Declare 'strAttribName' with an early-bound data type                              FixIT90210ae-R1672-R1B8ZE
...
' CORE249
'FIXIT: Declare 'vvarDate' with an early-bound data type                                   FixIT90210ae-R1672-R1B8ZE
...
'FIXIT: Declare 'vValue' with an early-bound data type                                     FixIT90210ae-R1672-R1B8ZE
...
'FIXIT: Declare 'objWshShell' with an early-bound data type                                FixIT90210ae-R1672-R1B8ZE
...
Private Function adoCRUDGetNamedSchema(ByVal vstrSchemaName As String) As DOMDocument40
 ...
 On Error GoTo ErrHandlerGeneric   'SR 03/12/2007 : CORE00000339
...
' CORE249 ends
    ...
    'On Error Resume Next  'SR 03/12/2007:CORE00000339
    On Error GoTo ErrHandlerResumeNext 'SR 03/12/2007:CORE00000339
    Set xmlDoc = gcolNamedSchemas.Item(vstrSchemaName)
    'On Error GoTo 0  'SR 03/12/2007:CORE00000339 - remove 'On Error GoTo 0' prior to migration
    On Error GoTo ErrHandlerGeneric 'SR 03/12/2007:CORE00000339
...
'SR 03/12/2007 : CORE00000339 - Add a genric error handler and one specifically for resuming next line
    Exit Function
    
ErrHandlerResumeNext:
        Resume Next

ErrHandlerGeneric:
    Err.Raise Err.Number, Err.Source, Err.Description
    
'SR 03/12/2007 : CORE00000339 - End
End Function
...
'FIXIT: Declare 'strErrDesc' with an early-bound data type                                 FixIT90210ae-R1672-R1B8ZE
...
'FIXIT: Declare 'ConvertGuidIndex' with an early-bound data type                           FixIT90210ae-R1672-R1B8ZE
...
'FIXIT: Declare 'objWshShell' with an early-bound data type                                FixIT90210ae-R1672-R1B8ZE
    ...
    ' ik_20050804_CORE172_ends
        ...
        End If
        If Len(strRegValue) = 0 Then
'FIXIT: App.LogEvent method has no Visual Basic .NET equivalent and will not be upgraded.     FixIT90210ae-R7593-R67265
