...
'SR     23/01/08 CORE00000452 - run pre-migration convertor tool
'------------------------------------------------------------------------------------------
'BBG History
'
...
Public Const gstrCUSTOMEREMPLOYMENT_COMPONENT = "omCE"
Public Const gstrCUSTOMER_FINANCIAL_COMPONENT = "omCF"
Public Const gstrCOMPONENT_NAME = "omCR"
...
Public Const gstrTRANSACT_COMPONENT As String = "omTransact"
Public Const gstrCRM_COMPONENT = "omCRMLock"
