...
Public Function xmlCreateDOMObject() As FreeThreadedDOMDocument40
    ...
    Dim vxmlDOMDocument  As FreeThreadedDOMDocument40
    Set vxmlDOMDocument = New FreeThreadedDOMDocument40
    vxmlDOMDocument.setProperty "NewParser", True
    vxmlDOMDocument.validateOnParse = False
    vxmlDOMDocument.async = False
    Set xmlCreateDOMObject = vxmlDOMDocument
    Set vxmlDOMDocument = Nothing
End Function
