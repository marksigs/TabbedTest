...
Public Sub GetAllGlobalBandedParamValuesAsXml(ByVal vstrParamName As String, _
                                    ByVal strValueType As String, _
                                    ByRef vxmlResponse As IXMLDOMNode)

    Const cstrFunctionName As String = "GetAllGlobalBandedParamValuesAsXml"
    ...
    Set xmlElem = xmlDoc.createElement("BOGUS")
    Set xmlRootNode = xmlDoc.appendChild(xmlElem)
    Set xmlElem = xmlDoc.createElement("GLOBALBANDEDPARAM")
    xmlElem.setAttribute "ENTITYTYPE", "LOGICAL"
    ...
    Select Case UCase(strValueType)
        Case "STRING"
            Set xmlElem = xmlDoc.createElement("STRING")
            xmlElem.setAttribute "DATATYPE", "STRING"
            xmlElem.setAttribute "LENGTH", "30"
        ...
        Case "PERCENTAGE"
            ...
            xmlSchemaNode.appendChild xmlElem
        Case "MAXIMUM"
            Set xmlElem = xmlDoc.createElement("MAXIMUM")
            xmlElem.setAttribute "DATATYPE", "DOUBLE"
            xmlSchemaNode.appendChild xmlElem
        Case "BOOLEAN"
            Set xmlElem = xmlDoc.createElement("BOOLEAN")
   ...
   ' create REQUEST details
    ...
    xmlElem.setAttribute "NAME", vstrParamName
    Set xmlRequestNode = xmlRootNode.appendChild(xmlElem)
    If vxmlResponse Is Nothing Then
        Set vxmlResponse = xmlDoc.createElement("RESPONSE")
    End If
    adoGetRecordSetAsXML xmlRequestNode, xmlSchemaNode, vxmlResponse
